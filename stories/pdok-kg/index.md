...
We willen dat er meer huizen worden verkocht.  Één manier om dat voor
...
meeste potentie voor projectontwikkeling is.

## Deel 1: Vind een geschikte wijk

We beginnen te zoeken naar wijken in Nederland waar de omstandigheden
gunstig zijn voor verbeterde nieuwbouw.  Het CBS houdt gedetailleerde
statistieken bij van alle Nederlandse wijken.  We beiginnen met het in
beeld brengen van alle wijken waar matige stedelijkheid is: daarmee
sluiten we groengebieden waar niet gebouwd mag worden en sterk
stedelijke gebieden waar niet gebouwd kan worden uit:
...
Laten we hier nog enkele zoek criteria aan toevoegen:

  - De wijk moet woningen met een lage gemiddelde woningwaarde bevatten.
  - De wijk moet een relatief hoge woningvoorraad hebben.
  - De wijk moet veelal oudere woningen bevatten.

Wanneer we alle wijken in Nederland op basis van deze criteria
sorteren komen de volgende wijken boven drijven:
...
Twee van de kandidaat wijken blijken in Dordrecht te liggen, dus laten
we daar eens verder kijken.  Dit zijn de buurten in Dordrecht met in
de weergave hun gemiddelde woningwaardes:
