...
class ParcelUri:
    ...
    def get_parcel_uri(self, params):
        # Don't flood the server
        time.sleep(0.2)

        r = self.session.get('https://brk.basisregistraties.overheid.nl/api/v1/perceel', params=params)
        # Too many requests:
    ...
    def get_parcel_uri_from_sparql(self, params):
